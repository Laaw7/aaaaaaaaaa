...
<a class="navbar-brand" href="../">P4</a>
    ...
    <li class="nav-item">
        <a class="nav-link active" style="font-weight: bold;" aria-current="page" href="afficher.php">Produits</a>
        </li>
        <li class="nav-item">
    ...
    <div style="margin-right: 500px">
        <h5 style="color: #545659; opacity: 0.5;">Connecté en tant que: cbelkaibech</h5>
    </div>
